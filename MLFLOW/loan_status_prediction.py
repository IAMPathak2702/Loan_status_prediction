...
# Read the dataset
dataset = pd.read_csv("data/loan_data_set.csv")
...
# Take care of outliers using clipping
...
# Dropping ApplicantIncome and CoapplicantIncome columns
...
def mlflow_logging(model, X, y, name):
    """
    Log model performance and artifacts using MLflow.
...
# Logging models and their performance
